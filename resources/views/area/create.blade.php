            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('areas.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                    <select name="city" class="form-control @error('name') is-invalid @enderror" id="city">
                            ...
                            <div class="col-md-6">
                                <input id="longitude" type="text" class="form-control @error('name') is-invalid @enderror" name="longitude" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="col-md-6">
                                <input id="latitude" type="text" class="form-control @error('name') is-invalid @enderror" name="latitude" value="{{ old('name') }}" required autofocus>
                                @error('name')
