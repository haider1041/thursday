    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('brand_locations.update',$brand_locations) }}">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="longitude" type="text"
                                    ...
                                    value="{{ $brand_locations->longitude}}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="latitude" type="text"
                                    ...
                                    value="{{ $brand_locations->latitude}}" required autofocus>
                                @error('latitude')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
